...
#define	rBWSCON		(*(volatile	unsigned long *)0x48000000)
#define	rBANKCON0	(*(volatile	unsigned long *)0x48000004)
#define	rBANKCON1	(*(volatile	unsigned long *)0x48000008)
#define	rBANKCON2	(*(volatile	unsigned long *)0x4800000c)
#define	rBANKCON3	(*(volatile	unsigned long *)0x48000010)
#define	rBANKCON4	(*(volatile	unsigned long *)0x48000014)
#define	rBANKCON5	(*(volatile	unsigned long *)0x48000018)
#define	rBANKCON6	(*(volatile	unsigned long *)0x4800001C)
#define	rBANKCON7	(*(volatile	unsigned long *)0x48000020)
#define	rREFRESH		(*(volatile	unsigned long *)0x48000024)
#define	rBANKSIZE	(*(volatile	unsigned long *)0x48000028)
#define	rMRSRB6		(*(volatile	unsigned long *)0x4800002C)
#define	rMRSRB7		(*(volatile	unsigned long *)0x48000030)
...
#define	GPDDA1T	(*(volatile	unsigned long *)0x56000034)
...
//我自己加的，不保证正确性
/*
#define	_ISR_STARTADDRESS	0x33FFE700
#define	p
*/


/*参照https://www.cnblogs.com/liuchengchuxiao/p/4169147.html*/
//=============================================================================
